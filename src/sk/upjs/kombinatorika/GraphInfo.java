...
public class GraphInfo {
	 ...
	 * @param minDegree
	 *            minimum degree of a vertex in the graph
	 * @param maxDegree
	 ...
	 * @param whether the graph is directed
...
//	 */
	 ...
	 * 
	 * @param value
	 *            a boolean value that will be converted
			...
			if (colors[startLabel - 1] == -1) {
				...
				while (!stack.isEmpty()) {
					...
					for (Vertex neighbour : v.getOutNeighbours()) {
						...
						// graph is not bipartite if there are two vertices from
						// the
